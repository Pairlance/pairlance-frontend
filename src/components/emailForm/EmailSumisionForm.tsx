...
const EmailSubmissionForm = () => {
  ...
  return (
    <div className="flex justify-center items-center border border-[#D0D2D6] h-[726px] w-[700px] mx-auto rounded-[16px] my-10" style={{ fontFamily: "Lato" }}>
      <div className="bg-white p-8 max-w-md flex flex-col gap-5">
        ...
        >
          <div className="flex flex-col justify-center items-center h-[470x] w-[624px p-5 mx-auto">
            ...
            <p className="text-center text-[#5F6774] text-[18px] mb-6 leading-[21.6px] w-[476px]">
              The CVs of the selected candidates will be sent to the provided email address shortly.
            </p>
            <div className="flex space-x-4">
              <Button type="default" onClick={() => window.location.href = "/"} className="border border-[#1E3A8A] text-[#1E3A8A] p-[16px] h-[54px] rounded-[16px]">Return to Homepage</Button>
              <Button type="primary" onClick={() => window.location.href = "/matching"} className="bg-[#1E3A8A] text-[#FFFFFF] p-[16px] rounded-[16px] h-[54px]">Find More Candidates</Button>
            </div>
          </div>
        </Modal>
      </div>
